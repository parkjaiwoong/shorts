...
var esm = __webpack_require__(3373);
;// CONCATENATED MODULE: ./remotion/ShortForm.tsx


const calculateShortFormDuration = ({
  props,
  fps
}) => {
  ...
  const frames = props.scenes.reduce((total, scene) => {
    const duration = Number.isFinite(scene.durationInSeconds) ? scene.durationInSeconds : 1;
    return total + Math.ceil(duration * safeFps) + pauseFrames + transitionFrames;
  }, 0);
...
const Scene = ({
  ...
  const fadeIn = (0,esm.interpolate)(frame, [0, transitionFrames], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  ...
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: { backgroundColor: "black", opacity } }, /* @__PURE__ */ React.createElement(
    esm.Img,
    {
      src: (0,esm.staticFile)(scene.imagePath),
      style: {
        width: "100%",
        height: "100%",
        objectFit: "cover",
    ...
    /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          ...
          textShadow: "0 6px 18px rgba(0,0,0,0.6), 0 0 10px rgba(255,255,255,0.5)"
        }
      },
      revealed.map((word, wordIndex) => {
        const highlight = /(칼퇴|치트키|1초)/.test(word);
        const mixedColor = wordIndex % 2 === 0 ? "#ffffff" : "#ffff00";
...
const buildNarrationWindows = (scenes, fps, pauseFrames, transitionFrames) => {
  const windows = [];
  let cursor = 0;
  scenes.forEach((scene) => {
    const duration = Number.isFinite(scene.durationInSeconds) ? scene.durationInSeconds : 1;
    const durationInFrames = Math.ceil(duration * fps) + pauseFrames + transitionFrames;
    windows.push({
...
const BgmTrack = ({
  ...
  return /* @__PURE__ */ React.createElement(esm.Audio, { src: (0,esm.staticFile)(bgmPath), volume, loop: true });
};
const ShortForm = ({
  scenes,
  title,
  ...
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, null, bgmPath ? /* @__PURE__ */ React.createElement(
    BgmTrack,
    {
      scenes,
      bgmPath,
    ...
    const sequence = /* @__PURE__ */ React.createElement(
      esm.Sequence,
      {
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(esm.Audio, { src: (0,esm.staticFile)(scene.audioPath) })
      )
    );
    startFrame += durationInFrames - transitionFrames;
    return sequence;
  }), commentPrompt ? /* @__PURE__ */ React.createElement(esm.Sequence, { from: startFrame, durationInFrames: endCardFrames }, /* @__PURE__ */ React.createElement(
    esm.AbsoluteFill,
    {
      style: {
        justifyContent: "center",
    ...
    /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          ...
          fontFamily: "Pretendard, NanumSquare, sans-serif",
          color: "#ffff00",
          textShadow: "0 8px 20px rgba(0,0,0,0.8), 0 0 18px rgba(255,255,0,0.8)"
        }
      },
      commentPrompt
    )
...
/* harmony import */ var remotion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3373);
/* harmony import */ var remotion_no_react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1789);
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(617), __webpack_require__.e(501)]).then(__webpack_require__.bind(__webpack_require__, 1617)).then(({ StudioInternals }) => {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "shot-lo-pro:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkshot_lo_pro"] = self["webpackChunkshot_lo_pro"] || [];
